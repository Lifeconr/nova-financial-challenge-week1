...
class FinancialEDA:
    ...
    def __init__(self, news_path, stock_dir='Data/yfinance_data/'):
        """
        ...
        try:
            ...
            raise FileNotFoundError(f"News file {news_path} not found. Please ensure the file exists.")
            ...
            try:
                if os.path.exists(file_path):
                    ...
                    if all(col in df.columns for col in required_cols):
                        ...
                        print(f"Missing required columns in {stock}_historical_data.csv. Found columns: {df.columns.tolist()}")
                else:
                    print(f"Stock data file {file_path} not found. Skipping {stock}.")
